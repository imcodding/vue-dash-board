...
(function ($) {
    ...
    $.extend($.jqx._jqxTree.prototype, {
        ...
        _parseItem: function (item) {
            ...
            if (parentType) {
                html += ' item-parentType="' + item.parentType + '" ';
            }
            ...
            //
            if (item.parentType) {
                html += ' item-parentType="' + parentType + '" ';
            }
        ...
        _createItem: function (element) {
            ...
            var parentType = element.getAttribute('item-parentType');
            ...
            listTag.removeAttribute('item-parentType');
