...
<script>
    /* grid 관련 모든 js가 추가된 것이 아닌 최소로 필요한 것들만 추가된 상태 */
    import '@/lib/jqwidgets/js/jqxcore.js';
    import '@/lib/jqwidgets/js/jqxscrollbar.js'
    import '@/lib/jqwidgets/js/globalize.js'
    import '@/lib/jqwidgets/js/jqxgrid.js'
    import '@/lib/jqwidgets/js/jqxdata.js'
    import '@/lib/jqwidgets/js/jqxgrid.selection.js'
    import '@/lib/jqwidgets/js/jqxgrid.sort.js'
    import '@/lib/jqwidgets/js/jqxgrid.edit.js'
    import '@/lib/jqwidgets/js/jqxgrid.filter.js'
    import '@/lib/jqwidgets/js/jqxgrid.pager.js'
    import '@/lib/jqwidgets/js/jqxgrid.columnsresize.js'
    import '@/lib/jqwidgets/js/jqxdropdownlist.js'
    import '@/lib/jqwidgets/js/jqxlistbox.js'
