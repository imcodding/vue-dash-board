...
<script>
    ...
    import '@/lib/jqwidgets/js/jqxbuttons.js';
    import '@/lib/jqwidgets/js/jqxscrollbar.js';
    import '@/lib/jqwidgets/js/jqxpanel.js';
    import '@/lib/jqwidgets/js/jqxdragdrop.js';
    import '@/lib/jqwidgets/js/jqxtree.js';
    import '@/lib/jqwidgets/js/jqxcheckbox.js';
