var TopoConst = {
    ...
    envSetting: {
      ...
      smallIconMenu: 0,
      showHA: 0,
      gridAxisColor: '#000000', /* 눈금자 */
      gridLineColor: '#dddddd', /* 눈금선 */
      helpLineColor: '#FF0000', /* 안내선 */
    },
    ...
    digitClockSetting: {
		...
		helpLineSetting: {
			helpLineConf: ''
			//helpLineConf: '{"helpLineConf":[{"helpLineNo":"0","helpLineType":"V","position":"200"},{"helpLineNo":"1","helpLineType":"H","position":"200"}]}'
		},
      ...
      if (jsonConf != null) {
        ...
        // font Size
        if (jsonConf.hasOwnProperty("fontSize")) this.envSetting['fontSize'] = jsonConf.fontSize;
        else this.envSetting['fontSize'] = 16;
        ...
        this.envSetting['gridAxisColor'] = jsonConf.gridAxisColor || '#000000';
        /* 눈금자 */
        this.envSetting['gridLineColor'] = jsonConf.gridLineColor || '#dddddd';
        /* 눈금선 */
        this.envSetting['helpLineColor'] = jsonConf.helpLineColor || '#FF0000';
        /* 안내선 */

        this.envSetting['lineSize'] = jsonConf.lineSize || 2;
        this.envSetting['lineStyle'] = jsonConf.lineStyle || '';
        this.envSetting['lineLabelFontSize'] = jsonConf.lineLabelFontSize || 11;
        this.envSetting['lineLabelColor'] = jsonConf.lineLabelColor || '#a3a3a3';
        this.envSetting['lineLabel'] = jsonConf.lineLabel || '0';
        this.envSetting['linePerf'] = jsonConf.linePerf || '0';
      }
      ...
      var helpLineConf = JSON.parse(data.helplineConf);
      if (helpLineConf != null) {
        var keys = Object.keys(helpLineConf);
        for (var idx = 0; idx < keys.length; idx++) {
          var field = keys[idx];
          if (helpLineConf.hasOwnProperty(field)) {
            this.helpLineSetting[field] = helpLineConf[field];
          }
        }
      }
		},
